...
public static class MeetingEndingFunctionTool
{
            ...
            """
              {
                ...
                "properties": {
                  "type": {
                    "type": "string",
                    "description": "This must be \"会議終了前\"."
                  },
                  "value": {
                    "type": "object",
                    "description": "The settings about message to send before the end of the meeting.",
                    "properties": {
                      "enabled": {
                        "type": "boolean",
