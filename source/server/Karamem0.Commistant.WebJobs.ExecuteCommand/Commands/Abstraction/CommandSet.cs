...
public interface ICommandSet
{
    ...
    ICommandContext CreateContext(ConversationProperties conversationProperties, ConversationReference conversationReference);
...
public class CommandSet : ICommandSet
{
    ...
    public ICommandContext CreateContext(ConversationProperties conversationProperties, ConversationReference conversationReference)
    {
