...
) : ComponentDialog
{
        ...
        var card = new AdaptiveCard("1.3")
        {
            ...
            [
                new AdaptiveChoiceSetInput()
                {
                    ...
                    Value = commandOptions.StartMeetingSchedule.ToString()
                },
                new AdaptiveTextInput()
                {
                    ...
                    Value = commandOptions.StartMeetingMessage
                },
                new AdaptiveTextInput()
                {
                    Id = "Url",
                    ...
                    Value = commandOptions.StartMeetingUrl
                }
            ],
            Actions =
            [
    ...
    private async Task<DialogTurnResult> OnAfterAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken = default)
    {
        ...
        {
            commandSettings.StartMeetingSchedule = value.Value("Schedule", -1);
            commandSettings.StartMeetingMessage = value.Value<string>("Message", null);
            commandSettings.StartMeetingUrl = value.Value<string>("Url", null);
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = commandSettings.StartMeetingSchedule switch
                                        {
                                            -1 => "なし",
                                            0 => "予定時刻",
                                            _ => $"{commandSettings.StartMeetingSchedule} 分後"
                                        }
                                    }
                                ],
                                Width = "stretch"
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = $"{commandSettings.StartMeetingUrl}"
                                    }
                                ],
                                Width = "stretch"
                            }
