...
) : ComponentDialog
{
    ...
    private async Task<DialogTurnResult> OnAfterAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken = default)
    {
        ...
        {
            conversationProperties.StartMeetingSchedule = value.Value("Schedule", -1);
            conversationProperties.StartMeetingMessage = value.Value<string>("Message", null);
            conversationProperties.StartMeetingUrl = value.Value<string>("Url", null);
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = conversationProperties.StartMeetingSchedule switch
                                        {
                                            -1 => "なし",
                                            0 => "予定時刻",
                                            _ => $"{conversationProperties.StartMeetingSchedule} 分後"
                                        }
                                    }
                                ],
                                Width = "stretch"
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = $"{conversationProperties.StartMeetingUrl}"
                                    }
                                ],
                                Width = "stretch"
                            }
