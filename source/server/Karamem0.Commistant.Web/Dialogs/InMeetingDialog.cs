...
) : ComponentDialog
{
    ...
    private async Task<DialogTurnResult> OnAfterAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken = default)
    {
        ...
        {
            conversationProperties.InMeetingSchedule = value.Value("Schedule", 0);
            conversationProperties.InMeetingMessage = value.Value<string>("Message", null);
            conversationProperties.InMeetingUrl = value.Value<string>("Url", null);
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = conversationProperties.InMeetingSchedule switch
                                        {
                                            -1 => "なし",
                                            0 => "予定時刻",
                                            _ => $"{conversationProperties.InMeetingSchedule} 分ごと"
                                        }
                                    }
                                ],
                                Width = "stretch"
                        ...
                        [
                            ...
                            new AdaptiveColumn()
                            {
                                ...
                                [
                                    new AdaptiveTextBlock()
                                    {
                                        Text = $"{conversationProperties.InMeetingUrl}"
                                    }
                                ],
                                Width = "stretch"
                            }
